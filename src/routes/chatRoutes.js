...
router.use(createLimiter('chat-ip', { windowMs: 900000, limit: 2000, standardHeaders: 'draft-8', legacyHeaders: false, message: rateLimitMessage }));
router.use(authenticate);
router.use(createLimiter('chat-user', { windowMs: 60000, limit: 120, keyGenerator: (req) => req.user.id, standardHeaders: 'draft-8', legacyHeaders: false, message: rateLimitMessage }));
